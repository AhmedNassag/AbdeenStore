...
class GeneralController extends Controller
{
    ...
    public function warehouseProducts($warehouse_id)
    {
        ...
        foreach($product_warehouses as $product_warehouse) {
            ...
            $product_warehouse['product_machine_number'] = $product_warehouse->product->machine_number;
            $product_warehouse['product_motor_number'] = $product_warehouse->product->motor_number;
        }
