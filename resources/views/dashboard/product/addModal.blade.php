                ...
                <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <input id="machine_number" type="text" class="form-control" name="machine_number" value="{{ old('machine_number') }}">
                        </div>
                        <!-- motor_number -->
                        <div class="col-6">
                            <label for="motor_number" class="mr-sm-2">{{ trans('main.Motor Number') }} :</label>
                            <input id="motor_number" type="text" class="form-control" name="motor_number" value="{{ old('motor_number') }}">
                        </div>
                        <!-- color -->
                        <div class="col-6">
