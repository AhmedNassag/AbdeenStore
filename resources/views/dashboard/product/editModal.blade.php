            ...
            <div class="modal-body">
                ...
                <form action="{{ route('products.update', 'test') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <!-- machine_number -->
                        <div class="col-6">
                            <label for="machine_number" class="mr-sm-2">{{ trans('main.Machine Number') }} :</label>
                            <input id="machine_number" type="text" class="form-control" name="machine_number" value="{{ $item['machine_number'] }}">
                        </div>
                        <!-- motor_number -->
                        <div class="col-6">
                            <label for="motor_number" class="mr-sm-2">{{ trans('main.Motor Number') }} :</label>
                            <input id="motor_number" type="text" class="form-control" name="motor_number" value="{{ $item['motor_number'] }}">
                        </div>
                        <!-- color -->
                        <div class="col-6">
                            <label for="color" class="mr-sm-2">{{ trans('main.Color') }} :</label>
                            <input id="color" type="text" class="form-control" name="color" value="{{ $item['color'] }}">
                        </div>
                        <!-- model -->
                        <div class="col-6">
                            <label for="model" class="mr-sm-2">{{ trans('main.Model') }} :</label>
                            <input id="model" type="text" class="form-control" name="model" value="{{ $item['model'] }}">
                        </div>
                        <!-- type -->
                        <div class="col-6">
                            <label for="type" class="mr-sm-2">{{ trans('main.Type') }} :</label>
                            <input id="type" type="text" class="form-control" name="type" value="{{ $item['type'] }}">
                        </div>
                        <!-- category_id -->
                        <div class="col-6">
